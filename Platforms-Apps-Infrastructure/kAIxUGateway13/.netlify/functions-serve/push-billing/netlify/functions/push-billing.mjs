...
// netlify/functions/push-billing.js
...
var push_billing_default = wrap(async (req) => {
  const cors = buildCors(req);
  ...
  const action = (url.searchParams.get("action") || "summary").toString();
