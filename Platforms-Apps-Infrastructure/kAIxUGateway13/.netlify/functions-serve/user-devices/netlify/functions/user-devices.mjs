...
async function listDevicesForKey(api_key_id, limit = 200) {
  const res = await q(
...
// netlify/functions/user-devices.js
var user_devices_default = wrap(async (req) => {
  const cors = buildCors(req);
