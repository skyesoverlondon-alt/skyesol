...
// ../../netlify/functions/blog-delete.mjs
var blog_delete_exports = {};
__export(blog_delete_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(blog_delete_exports);
...
var handler = async (event, context) => {
  ...
  await s.setJSON("blog:index", { updated_at: (/* @__PURE__ */ new Date()).toISOString(), posts: next });
