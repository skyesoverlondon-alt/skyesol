...
function randomKey(prefix = "kx_live_") {
...
var admin_keys_default = wrap(async (req) => {
  const cors = buildCors(req);
  ...
  if (req.method === "POST") {
    ...
    const allowedRoles = /* @__PURE__ */ new Set(["viewer", "deployer", "admin", "owner"]);
    if (!allowedRoles.has(role)) return badRequest("Invalid role (viewer|deployer|admin|owner)", cors);
    const monthly_cap_cents = body.monthly_cap_cents === null || body.monthly_cap_cents === void 0 ? null : parseInt(body.monthly_cap_cents, 10);
    const rpm_limit = body.rpm_limit === null || body.rpm_limit === void 0 ? null : parseInt(body.rpm_limit, 10);
    const rpd_limit = body.rpd_limit === null || body.rpd_limit === void 0 ? null : parseInt(body.rpd_limit, 10);
    const max_devices = body.max_devices === null || body.max_devices === void 0 ? null : parseInt(body.max_devices, 10);
