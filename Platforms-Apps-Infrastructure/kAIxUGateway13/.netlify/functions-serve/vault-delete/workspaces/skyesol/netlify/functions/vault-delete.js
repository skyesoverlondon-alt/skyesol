...
// ../../netlify/functions/vault-delete.mjs
var vault_delete_exports = {};
__export(vault_delete_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(vault_delete_exports);
...
var handler = async (event, context) => {
  ...
  await s.setJSON("vault:index", { updated_at: (/* @__PURE__ */ new Date()).toISOString(), docs: next });
...
//# sourceMappingURL=vault-delete.js.map
