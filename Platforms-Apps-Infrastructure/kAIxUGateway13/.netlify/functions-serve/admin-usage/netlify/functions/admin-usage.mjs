...
// netlify/functions/admin-usage.js
var admin_usage_default = wrap(async (req) => {
  const cors = buildCors(req);
  ...
  const month = (url.searchParams.get("month") || (/* @__PURE__ */ new Date()).toISOString().slice(0, 7)).toString().slice(0, 7);
