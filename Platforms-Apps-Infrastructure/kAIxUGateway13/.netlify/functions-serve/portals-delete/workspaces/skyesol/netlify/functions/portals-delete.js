...
// ../../netlify/functions/portals-delete.mjs
var portals_delete_exports = {};
__export(portals_delete_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(portals_delete_exports);
...
var handler = async (event, context) => {
  ...
  await s.setJSON("portals:list", { updated_at: (/* @__PURE__ */ new Date()).toISOString(), portals: next });
...
//# sourceMappingURL=portals-delete.js.map
