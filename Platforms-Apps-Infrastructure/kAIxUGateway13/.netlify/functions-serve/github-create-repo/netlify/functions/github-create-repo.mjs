...
// netlify/functions/github-create-repo.js
var github_create_repo_default = wrap(async (req) => {
  const cors = buildCors(req);
  ...
  const hasIssues = body.has_issues === void 0 ? true : !!body.has_issues;
  const hasProjects = body.has_projects === void 0 ? false : !!body.has_projects;
  const hasWiki = body.has_wiki === void 0 ? false : !!body.has_wiki;
  const autoInit = body.auto_init === void 0 ? true : !!body.auto_init;
