...
// netlify/functions/admin-voice-numbers.js
var admin_voice_numbers_default = wrap(async (req) => {
  const cors = buildCors(req);
  ...
  if (req.method === "PATCH") {
    ...
    if (body.twilio_sid !== void 0) set("twilio_sid", body.twilio_sid || null);
